...
describe Yasminaai::Internal::Types::Union do
  class Rectangle < Yasminaai::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Yasminaai::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Yasminaai::Internal::Types::Model
