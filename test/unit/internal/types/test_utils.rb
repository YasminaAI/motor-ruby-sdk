...
describe Yasminaai::Internal::Types::Utils do
  Utils = Yasminaai::Internal::Types::Utils

  module TestUtils
    class M < Yasminaai::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Yasminaai::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Yasminaai::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Yasminaai::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Yasminaai::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend Yasminaai::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = Yasminaai::Internal::Types::Array[String]
      ModelArray = -> { Yasminaai::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Yasminaai::Internal::Types::Array[TestUtils::U] }
