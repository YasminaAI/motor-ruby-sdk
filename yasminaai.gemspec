...
require_relative "lib/yasminaai/version"
...
Gem::Specification.new do |spec|
  spec.name = "yasmina-motor-ruby"
  spec.authors = ["Yasminaai"]
  spec.version = Yasminaai::VERSION
  spec.summary = "Ruby client library for the Yasminaai API"
  spec.description = "The Yasminaai Ruby library provides convenient access to the Yasminaai API from Ruby."
